...
const HotelCreate = () => {
    ...
    const handleSubmit = (e) => {
        try {
            ...
            axios.post('/api/v1/admin/createHotels',
                formData, {
                headers: {
            ...
            <div className='d-flex flex-column align-items-center pt-4'>
                ...
                <form class="row g-3 w-50" onSubmit={handleSubmit}  >
                    ...
                    <div class="col-10 d-flex flex-row">
                        <label for="image" class="form-label me-2"><strong>Image</strong></label>
                        <input type="file" class="form-control me-2" id="image" name='filename' placeholder='Select Image'
